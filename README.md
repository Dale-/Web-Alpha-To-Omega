...
* ES6: let、const、变量的解构、字符串的扩展、正则的扩展、[数值的扩展](https://github.com/Dale-/Web-Alpha-To-Omega/blob/master/js/ES6/array-es6.md)、函数的扩展、数组的扩展、对象的扩展、Symbol、Set Map、Promise、Class、inherit [[Entry]](http://es6.ruanyifeng.com/)
